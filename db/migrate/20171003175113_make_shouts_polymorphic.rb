class MakeShoutsPolymorphic < ActiveRecord::Migration[5.1]
  ...
  def change
    ...
    reversible do |dir|
      # Don't want to use rails models for shouts. Validations may cause fail during the migration
      # Instead, define classes at the top of the file. It will use these fake models first.
